...
namespace HW2
{
    public partial class BestOil : Form
    {
        ...
        void UpdateStatusStrip(object sender,EventArgs e)
        {
            DateTime dateTime = new DateTime();
            toolStripStatusLabel1.Text = DateTime.Now.ToString();

            toolStripDropDownButton1.Text = Date(dateTime.Day, dateTime.Month, dateTime.Year).ToLower();
            toolStripDropDownButton1.Text= toolStripDropDownButton1.Text.Replace(toolStripDropDownButton1.Text.ElementAt(0).ToString(), toolStripDropDownButton1.Text.ElementAt(0).ToString().ToUpper());
        ...
        private void backgroungColorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            RGB rgb = new RGB(BackColor.R, BackColor.G, BackColor.B);
            Ex1RGB ex1RGB = new Ex1RGB(rgb);
            ex1RGB.ShowDialog();
            BackColor = Color.FromArgb(rgb.R,rgb.G,rgb.B);  
            menuStrip1.BackColor= Color.FromArgb(rgb.R, rgb.G, rgb.B);
            statusStrip1.BackColor = Color.FromArgb(rgb.R, rgb.G, rgb.B);
        }
    }
}
